...
strip target/x86_64-apple-darwin/release/warp-runner
	cargo build -p warp-runner --release --target aarch64-apple-darwin
strip target/aarch64-apple-darwin/release/warp-runner
...
strip target/x86_64-apple-darwin/release/warp-packer
	cargo build -p warp-packer --release --target aarch64-apple-darwin
strip target/aarch64-apple-darwin/release/warp-packer
